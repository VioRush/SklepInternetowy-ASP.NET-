...
namespace SklepInternetowy.Models
{
    ...
    public class ApplicationUser : IdentityUser   //opisuje uzytk.
    {
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>   //modele potrzebne do opisu użytk.
    {
		...
		public DbSet<Okładka> Okładki { get; set; }
